...
public class Avatar {
    ...
    public void setOnKeyPressed(KeyEvent event){
        switch (event.getCode()){
            ...
            case DOWN ->{ state = 1; downPressed = true;}
            case LEFT -> { state = 1;leftPressed = true;}
            case RIGHT -> { state = 1;rightPressed = true;}
        }
    }
    ...
    public void setOnKeyReleassed(KeyEvent event){
        switch (event.getCode()){
            ...
            case DOWN ->{ state = 0; downPressed = false;}
            case LEFT -> { state = 0;leftPressed = false;}
            case RIGHT -> { state = 0;rightPressed = false;}
        }
    }
